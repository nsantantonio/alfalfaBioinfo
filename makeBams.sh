...
# BEWARE THIS MAY NOT WORK OR HAVE BUGS IN IT!!!!!!!!!!!!!!!

# nC=40
# mapq=20
# # genome="/local/rdata//local/rdata/dbgap_robbins/alfalfa3a.2/MainGenome/3a.2-bionano+unscaffolded-assembly.fa"
# # using just the first 978 scaffolds, as they appear to be the main genome sequence. Wrote Andrew Farmer email to confirm
# genome="/local/rdata/dbgap_robbins/alfalfaMainGenome/3a.2-bionano+unscaffolded-assembly_1to978.fa"
# workDir=alfalfaWorkdir
# seqDir=alfalfaNovaSeq
...
# while read f; do
# 	bwa mem -t ${nC} ${genome} ${seqDir}/${i}_L001_R1_001.fastq.gz ${seqDir}/${i}_L001_R2_001.fastq.gz > ${bamDir}/${i}_L001_aln.sam
# 	bwa mem -t ${nC} ${genome} ${seqDir}/${i}_L002_R1_001.fastq.gz ${seqDir}/${i}_L002_R2_001.fastq.gz > ${bamDir}/${i}_L002_aln.sam
# 	samtools view -b -q ${mapq} -@${nC} ${bamDir}/${i}_L001_aln.sam > ${bamDir}/${i}_L001_mapq${mapq}.bam
# 	samtools view -b -q ${mapq} -@${nC} ${bamDir}/${i}_L002_aln.sam > ${bamDir}/${i}_L002_mapq${mapq}.bam
# 	rm ${bamDir}/${i}_L001_aln.sam ${bamDir}/${i}_L002_aln.sam
# done < ${workDir}/gidWells.txt
...
# zcat alfalfaNovaSeq/alfalfaDNAext-A01-AfricanxMfalcata-Rep1_S1_L001_R1_001.fastq.gz | head -1000
